                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_firstname" class="form-control" placeholder="First Name" name="firstname"  value="{{old('firstname')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_middlename" class="form-control" placeholder="Middle Name" name="middlename" value="{{old('middlename')}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_lastname" class="form-control" placeholder="Last Name" name="lastname" value="{{old('lastname')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_suffix" class="form-control" placeholder="Suffix" name="suffix" value="{{old('suffix')}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="input_email" class="form-control" placeholder="Email" name="email" value="{{old('email')}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_contact" class="form-control" placeholder="+63" name="contact" value="{{old('contact')}}">
