                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_title" class="form-control" placeholder="Title" name="title"  value="{{$category->title}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor" name="description" class="form-control" placeholder="Your text here.">{{$category->description}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                {!! html()->select('status', $statuses, value($category->status), ['id' => "input_status"])->class('form-control') !!}
