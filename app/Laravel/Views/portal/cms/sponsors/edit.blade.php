    ...
    <div class="col-sm-12 col-md-10 col-lg-8 col-xl-6">
        ...
        <div class="card shadow mb-4 border-bottom-secondary">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Sponsor</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_sponsor" class="form-control" placeholder="Sponsor" name="sponsor" value="{{$sponsor->name}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="input_logo">Change Logo</label>
