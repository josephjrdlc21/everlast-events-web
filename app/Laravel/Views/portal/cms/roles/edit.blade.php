            ...
            <div class="card shadow mb-4 border-bottom-secondary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="input_role" class="form-control" placeholder="Name" name="role" value="{{$role->name}}">
                    ...
                    <div class="form-group mb-4">
                        ...
                        {!! html()->select('status', $statuses, value($role->status), ['id' => "input_status"])->class('form-control') !!}
