                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="input_question" class="form-control" placeholder="Question" name="question" value="{{$faq->question}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor" name="answer" class="form-control" placeholder="Your text here.">{{$faq->answer}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                {!! html()->select('status', $statuses, value($faq->status), ['id' => "input_status"])->class('form-control') !!}
