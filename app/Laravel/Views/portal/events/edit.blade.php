                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="start_date" value="{{Carbon::parse($event->event_start)->format('Y-m-d')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="end_date" value="{{Carbon::parse($event->event_end)->format('Y-m-d')}}">
